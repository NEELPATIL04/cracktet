...
export default function Register() {
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-secondary-gray py-12">
      {/* Enhanced Welcome Popup with INCREASED DELAYS */}
      {showWelcomePopup && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            ...
            {/* Enhanced Content with MUCH LONGER DELAYS */}
              ...
              <div className="space-y-6">
                ...
                {welcomeContent[popupLanguage].sections.map((section, sectionIndex) => (
                  <motion.div
                    ...
                    transition={{ 
                      duration: 0.6, 
                      delay: 1.0 + sectionIndex * 0.8  // Much longer delay between sections
                    }}
                    className="space-y-3"
                  >
                    {/* Section Heading */}
                      ...
                      <ul className="list-disc list-outside pl-6 md:pl-8 space-y-2">
                        {section.items?.map((item, itemIndex) => (
                          <motion.li
                            ...
                            transition={{ 
                              duration: 0.5, 
                              delay: 1.2 + sectionIndex * 0.8 + itemIndex * 0.3  // 0.3s between each bullet
                            }}
                ...
                <motion.div
                  ...
                  transition={{ 
                    duration: 0.6, 
                    delay: 4.5  // Appears after all content
                  }}
